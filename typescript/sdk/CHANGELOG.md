...
- 82cebabe: Call google storage API directly and remove @google-cloud/storage dependency from the SDK.
- 95cc9571: Deploy to new chains: arthera, aurora, conflux, conwai, corn, evmos, form, ink, rivalz, soneium, sonic, telos.

### Patch Changes

- 472b3467: Bump registry version to v6.3.0.
- 5942e9cf: Update default validator sets for alephzeroevmmainnet, appchain, lisk, lumiaprism, swell, treasure, vana, zklink.
- Updated dependencies [79f8197f]
- Updated dependencies [0eb8d52a]
